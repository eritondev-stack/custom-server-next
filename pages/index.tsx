...
import LoginOffie from '../assets/img/login-office.jpeg'
import LoginOffieDark from '../assets/img/login-office-dark.jpeg'
        ...
        <div className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
          <div className="w-full">
            ...
            <label className="block text-sm">
              ...
              <input
                className="block w-full mt-1 py-2 px-1 rounded-md text-sm border dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-purple-400 dark:text-gray-300 form-input"
